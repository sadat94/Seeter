 ...
 */
/**
 * Abstract classes for the basic model-view-controller (MVC) architecture you
 * will use in this exercise.
 * <p>
 * You will extend (<i>i.e.</i>, subclass) these application-independent base
 * classes to implement your Seeter client application.
 */
package sep.mvc;
